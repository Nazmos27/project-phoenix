    ...
    <div className='flex md:flex-row flex-col justify-center items-center px-10'>
      <div className='order-last md:order-first'>
        <ul className='space-y-4'>
          <li className='flex gap-3 px-4 md:justify-start justify-center text-3xl md:text-4xl items-center md:h-12 h-32 text-center py-3 md:w-[330px] shadow-2xl rounded-lg min-w-[500px]  border-gray-300 border-[2px]'>
