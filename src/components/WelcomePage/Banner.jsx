...
export default function Banner() {
  return (
    <div className='flex md:flex-row flex-col justify-center items-center px-10'>
      <div className='order-last md:order-first'>
        <ul className='space-y-4'>
          <li className='flex gap-3 px-4 md:justify-start justify-center text-4xl items-center md:h-12 h-32 text-center py-3 md:w-[330px] min-w-[600px] shadow-2xl rounded-lg'>
            <img src="public/Photos/bannerIcon/locationprivacy-svgrepo-com.svg" className='md:h-10 md:w-10 h-20 w-20' alt="" />Track your class-time easily</li>
